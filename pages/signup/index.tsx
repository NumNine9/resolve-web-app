    ...
    if (isSignUp){
      ...
      const { error } = await supabase.auth.signUp({
          ...
          if (error) {
            ...
            router.push("/deashboard"); //was previously home
          }
          e.preventDefault();
    }else{
      const supabase = await createClient()
      ...
      if (error) {
        ...
        router.push('/dashboard')  //was previously home
      }
      e.preventDefault();
  ...
  return (
    ...
    <div className="flex min-h-svh flex-col items-center justify-center bg-muted p-6 md:p-10">
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              {isSignUp ? 
              <Button onClick={(e)=> handleUser(e)} className="w-full">
              Sign Up
            </Button>
              :
               <Button onClick={(e)=> handleUser(e)} className="w-full">
              ...
              {isSignUp ? 
              <div className="text-center text-sm" onClick={()=> setSignin(!isSignUp)}>
      ...
      <div className="flex items-center justify-center h-screen">
        <HashLoader size={80} color="#5c6499" />
      </div>
